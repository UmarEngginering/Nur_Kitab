Nur_Kitab --Aplikasi Islam Digital 
...
5. **Navigasi Dinamis** : Sistem routing otomatis menggunakan satu templet halaman untuk semua isi bacaan.

## Teknologi
1. **Flutter** : Framework utama.
2. **Dart** : Bahasa pemrograman.
3. **Material Design** : Untuk komponen UI yang modern.
